...
var DefaultProfiles = []Profile{
	...
	{Agent: "claude-code", Provider: "anthropic", Model: "haiku", CostLevel: 1, UseFor: "tareas mecanicas con instrucciones cerradas cuando se quiere usar Claude barato", Verified: true},
	...
	{Agent: "claude-code", Provider: "anthropic", Model: "sonnet", CostLevel: 3, UseFor: "codigo, revision critica, seguridad, bloqueos y refutacion de decisiones", ReviewOnly: true, Verified: true},
	{Agent: "claude-code", Provider: "anthropic", Model: "opus", CostLevel: 4, UseFor: "arquitectura compleja, auditoria critica o decision mayor", ReviewOnly: true, Verified: true},
